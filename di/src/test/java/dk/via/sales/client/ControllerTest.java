...
public class ControllerTest extends EasyMockSupport {
	...
	public void addItemAddsAnItemToTheModelAndUpdatesView() {
		List<OrderLine> orderLines = Collections.singletonList(new OrderLine(1, items.get(0)));
	...
	public void addingTheSameItemTwiceUpdatesTheAmount() {
		List<OrderLine> orderLines1 = Collections.singletonList(new OrderLine(1, items.get(0)));
		List<OrderLine> orderLines2 = Collections.singletonList(new OrderLine(2, items.get(0)));
		expect(mockView.getItemIndex()).andReturn(0);
	...
	public void confirmingOrderSavesTheOrderAndResetsTheView() {
		...
		mockView.displayOrderLines(Collections.emptyList());
		replayAll();
	...
	@Test
	public void confirmingAnEmptyOrderDoesNothing() {
		expect(mockModel.getOrderLines()).andReturn(Collections.emptyList());
		replayAll();
