...
public class PersistenceImpl extends DataAccessObject implements SalesPersistence {
	private static PersistenceImpl instance;

	private PersistenceImpl() {
	}

	public static synchronized PersistenceImpl getInstance() {
		if (instance == null) {
			instance = new PersistenceImpl();
		}
		return instance;
	}
	...
	/* (non-Javadoc)
	 * @see dk.via.dk.via.sales.data.SalesPersitence#getCustomers()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dk.via.dk.via.sales.data.SalesPersitence#getCustomerByEmail(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dk.via.dk.via.sales.data.SalesPersitence#createCustomer(dk.via.dk.via.sales.model.Customer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dk.via.dk.via.sales.data.SalesPersitence#updateCustomer(dk.via.dk.via.sales.model.Customer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dk.via.dk.via.sales.data.SalesPersitence#deleteCustomer(dk.via.dk.via.sales.model.Customer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dk.via.dk.via.sales.data.SalesPersitence#getOrdersForCustomer(dk.via.dk.via.sales.model.Customer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dk.via.dk.via.sales.data.SalesPersitence#createOrderForCustomer(dk.via.dk.via.sales.model.Customer, java.lang.String, java.util.Collection)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dk.via.dk.via.sales.data.SalesPersitence#createItem(java.lang.String, dk.via.dk.via.sales.model.Money)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dk.via.dk.via.sales.data.SalesPersitence#getItems()
	 */
	@Override
